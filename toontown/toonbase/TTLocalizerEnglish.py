...
CogdoCraneGameInstructions = 'The COGs are using a coin-operated machine to destroy Laff Barrels. Use the cranes to pick up and throw money bags at them in order to prevent Barrel destruction!'
CogdoCraneIntroMovieDialogue = (("You Toons have dropped the bag on this one! We're financially backing the destruction of your Laff Barrels and you're powerless to stop us!", "You Toons are stuck in baggage claim! We're crushing your Barrels of your 'precious' Laff, and there's nothing you can do about it!", "You won't be able to bag us, Toons! We're powering our offices with your Laff, and you cannot stop us!"), ('This is the Toon Resistance! These COGs have some serious baggage! Hop on a crane and fling money bags at the COGs to stop them from destroying our Laff! Good Luck!', 'Attention Toons! Put these COGs in the bag using their cranes! Knock out the COGs by tripping them up with money bags. Toon Resistance out!', 'Toon Resistance here! Bag the COGs up by using the cranes! Send money bags flying at the COGs before they can use the %s. Good luck and have fun!' % CogdoStomperName), ("Huff! I'm a Gold Sprocket Award winner, I don't need this!", "Time to bring in the big bags!", "Careful, we have some serious baggage!"))
...
CogdoCraneGameUseCrane = "Press 'Ctrl' to use your crane!"
CogdoCraneIntermissionMovieDialogue = (("This is the Toon Resistance! We're using Portable Holes to transport saved Laff Barrels for extra laff points!", "Toon Resistance here! We've transported some Laff Barrels to you for a Toon-Up!", "Attention Toons! Grab some Laff from these Laff Barrels we've transported!"), ("Don't let the COGs steal them away! Use the money bags to destroy the COGs.", "Remember to knock out the COGs with the money bags!", "Don't let the Money Bags steal your money bags!"))
